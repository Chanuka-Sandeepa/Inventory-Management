...
export default function AddOrder() {
  ...
  const sendData = (e) => {
    ...
    if (!product_name || !category || !brand || !model || !quantity || !description || !supplier_id ||!supplier_name) {
      alert("Please fill all the fields");
      return;
    }

    axios
      .post("http://localhost:3000/api/supplierorder/add", newOrder)
      .then(() => {
        alert("Product Added");
        setProductName("");
        setCategory("");
    ...
    <div style={pageStyle}>
      ...
      <div style={formStyle}>
        <form onSubmit={sendData}>
          ...
          <div style={formGroupStyle}>
            <label htmlFor="supllier_name" style={labelStyle}>
              Supplier Name
            </label>
            <input
              type="text"
